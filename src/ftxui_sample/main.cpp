...
// configuration step. It creates a namespace called `interpreting`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", interpreting::cmake::project_name, interpreting::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", interpreting::cmake::project_version);
      return EXIT_SUCCESS;
    }
